  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "blob-float-1": "blob-float-1 25s ease-in-out infinite",
        "blob-float-2": "blob-float-2 30s ease-in-out infinite",
        "blob-float-3": "blob-float-3 28s ease-in-out infinite",
        "blob-float-4": "blob-float-4 32s ease-in-out infinite",
      },
    },
  },
